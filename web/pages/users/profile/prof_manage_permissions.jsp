<%-- 
    Document   : prof_manage_permissions
    Created on : 16-Apr-2019, 15:06:25
    Author     : ndfmac
--%>
...
<html lang="en">
    <head>
        ...
        <title>WM-Manager - :: Manage Staff Permissions</title>
    ...
    <body class="navbar-top">
        ...
        <div class="page-content">
            ...
            <!-- Main content -->
            <jsp:include page="../../../WEB-INF/static_pages/users/profile/manage_permission.jsp"></jsp:include>
            <!-- /main content -->
        </div>
        <!-- /page content -->
