<%-- 
    Document   : my_monetisation_applications
    Created on : Jun 28, 2019, 9:44:22 AM
    Author     : Ebuka
--%>
...
<html lang="en">
    ...
    <body class="navbar-top">
        ...
        <div class="page-content">
            ...
            <!-- Main content -->
            <jsp:include page="../../../WEB-INF/static_pages/users/schemes/my_monetisation_applications.jsp"></jsp:include>
            <!-- /main content -->
        </div>
        <!-- /page content -->
