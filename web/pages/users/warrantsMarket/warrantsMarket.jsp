<%-- 
    Document   : warrantsMarket
    Created on : 03-Oct-2018, 17:47:29
    Author     : ndfmac
--%>
...
<html lang="en">
    <head>
        ...
        <title>WM-Manager - All Listings</title>
    ...
    <body class="navbar-top">
        ...
        <div class="page-content">
            ...
            <!-- Main content -->
            <jsp:include page="../../../WEB-INF/static_pages/users/warrantsMarket/warrantsMarket.jsp"></jsp:include>
            <!-- /main content -->
        </div>
        <!-- /page content -->
