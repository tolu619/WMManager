<%-- 
    Document   : monetisation_verify
    Created on : Jun 12, 2019, 12:30:10 PM
    Author     : Ebuka
--%>
...
<html lang="en">
    <head>
        ...
        <title>WM-Manager - Verify Monetisation Product/Service</title>
    ...
    <body class="navbar-top">
        ...
        <div class="page-content">
            ...
            <!-- Main content -->
            <jsp:include page="../../../WEB-INF/static_pages/users/schemes/monetisation_verify.jsp"></jsp:include>
            <!-- /main content -->
        </div>
        <!-- /page content -->
