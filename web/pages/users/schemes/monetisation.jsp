<%-- 
    Document   : monetisation
    Created on : 08-Nov-2018, 14:30:43
    Author     : ndfmac
--%>
...
<html lang="en">
    <head>
        ...
        <title>WM-Manager - Monetisation</title>
    ...
    <body class="navbar-top">
        ...
        <div class="page-content">
            ...
            <!-- Main content -->
            <jsp:include page="../../../WEB-INF/static_pages/users/schemes/monetisation.jsp"></jsp:include>
            <!-- /main content -->
        </div>
        <!-- /page content -->
