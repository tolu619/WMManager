<%-- 
    ...
    Created on : 23-Jan-2019, 15:36:02
    Author     : ndfmac
--%>
...
<html lang="en">
    <head>
        ...
        <title>WM-Manager - Permission :: Permission Groups</title>
    ...
    <body class="navbar-top">
        ...
        <div class="page-content">
            ...
            <!-- Main content -->
            <jsp:include page="../../../WEB-INF/static_pages/users/permissions/permissiongroups.jsp"></jsp:include>
            <!-- /main content -->
        </div>
        <!-- /page content -->
