<%-- 
    Document   : parcash
    Created on : 09-Oct-2018, 09:10:42
    Author     : ndfmac
--%>
...
<html lang="en">
    <head>
        ...
        <title>WM-Manager - All WM-Transactions</title>
    ...
    <body class="navbar-top">
        ...
        <div class="page-content">
            ...
            <!-- Main content -->
            <jsp:include page="../../../WEB-INF/static_pages/users/accounts/transactions.jsp"></jsp:include>
            <!-- /main content -->
        </div>
        <!-- /page content -->
