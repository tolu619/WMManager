<%-- 
    Document   : proposedpermissions
    Created on : 25-Apr-2019, 13:07:43
    Author     : ndfmac
--%>
...
<html lang="en">
    <head>
        ...
        <title>WM-Manager - Permission :: Manage Permission</title>
    ...
    <body class="navbar-top">
        ...
        <div class="page-content">
            ...
            <!-- Main content -->
            <jsp:include page="../../../WEB-INF/static_pages/users/permissions/proposedpermissions.jsp"></jsp:include>
            <!-- /main content -->
        </div>
        <!-- /page content -->
