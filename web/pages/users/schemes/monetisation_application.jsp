<%-- 
    Document   : monetisation_application
    Created on : May 10 , 2019, 10:54:39 AM
    Author     : Ebuka
--%>
...
<html lang="en">
    <head>
        ...
        <title>WM-Manager - Apply for Monetisation</title>
    ...
    <body class="navbar-top">
        ...
        <div class="page-content">
            ...
            <!-- Main content -->
            <jsp:include page="../../../WEB-INF/static_pages/users/schemes/monetisation_application.jsp"></jsp:include>
            <!-- /main content -->
        </div>
        <!-- /page content -->
