<%-- 
    Document   : offline
    Created on : 02-Nov-2018, 14:02:32
    Author     : ndfmac
--%>
...
<html lang="en">
    <head>
        ...
        <title>WM-Manager - Error Page</title>
        ...
        <!-- Theme JS files -->
        <script src="../../global_assets/js/app.js" type="text/javascript"></script>
    ...
    <body>
        ...
        <jsp:include page="../../WEB-INF/static_pages/general/offline.jsp"></jsp:include>
