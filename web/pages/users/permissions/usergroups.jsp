<%-- 
    Document   : usergroups
    Created on : 23-Jan-2019, 15:36:13
    Author     : ndfmac
--%>
...
<html lang="en">
    <head>
        ...
        <title>WM-Manager - Permission :: User Groups</title>
    ...
    <body class="navbar-top">
        ...
        <div class="page-content">
            ...
            <!-- Main content -->
            <jsp:include page="../../../WEB-INF/static_pages/users/permissions/usergroups.jsp"></jsp:include>
            <!-- /main content -->
        </div>
        <!-- /page content -->
