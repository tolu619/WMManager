<%-- 
    Document   : services_categories
    Created on : Apr 15, 2019, 6:00:59 PM
    Author     : Ebuka
--%>
...
<html lang="en">
    <head>
        ...
        <title>WM-Manager - Shop Services Categories</title>
    ...
    <body class="navbar-top">
        ...
        <div class="page-content">
            ...
            <!-- Main content -->
            <jsp:include page="../../../WEB-INF/static_pages/users/shop/services_categories.jsp"></jsp:include>
            <!-- /main content -->
        </div>
        <!-- /page content -->
