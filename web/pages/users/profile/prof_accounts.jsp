<%-- 
    Document   : accounts
    Created on : 18-Mar-2019, 16:07:28
    Author     : ndfmac
--%>
...
<html lang="en">
    <head>
        ...
        <title>WM-Manager - :: Accounts & Transactions</title>
    ...
    <body class="navbar-top">
        ...
        <div class="page-content">
            ...
            <!-- Main content -->
            <jsp:include page="../../../WEB-INF/static_pages/users/profile/accounts.jsp"></jsp:include>
            <!-- /main content -->
        </div>
        <!-- /page content -->
