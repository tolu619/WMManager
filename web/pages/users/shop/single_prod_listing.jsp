<%-- 
    Document   : shop
    Created on : 14-Dec-2018, 15:04:37
    Author     : ndfmac
--%>
...
<html lang="en">
    <head>
        ...
        <title>WM-Manager - Shop - List New Products</title>
    ...
    <body class="navbar-top sidebar-xs">
        ...
        <div class="page-content">
            ...
            <!-- Main content -->
            <jsp:include page="../../../WEB-INF/static_pages/users/shop/single_prod_listing.jsp"></jsp:include>
            <!-- /main content -->
        </div>
        <!-- /page content -->
