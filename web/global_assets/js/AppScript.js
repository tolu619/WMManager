...
//            var ContractDuration = $("#contractDuration").val();
    ...
    $("#ViewAcctStmt").click(function () {
        ...
        var file_url = extension + "global_assets/img/PDFAccountStatements/account-statement-user-" + acctstmtuserid + ".pdf";
...
function DisplayShopProducts(data) {
    ...
    if (data === "none") {
        ...
        $.each(data, function (id, details) {
            var newchild = childClone.clone();
            newchild.removeClass("clone");
            var image_url = extension + "global_assets/img/ProductImages/product-" + id + ".png";
            if (imageExists(image_url) === false) {
                image_url = extension + "global_assets/img/ProductImages/product-0.png";
            }
            newcount++;
...
function DisplayProductsForPromo(data) {
    ...
    if (data === "none") {
        ...
        $.each(data, function (id, details) {
            ...
            var image_url = extension + "global_assets/img/ProductImages/product-" + details["product_id"] + ".png";
            if (imageExists(image_url) === false) {
                image_url = extension + "global_assets/img/ProductImages/product-0.png";
            }
            newcount++;
...
function DisplayListedProduct(data) {
    ...
    if (data === "none") {
        ...
        $.each(data, function (id, details) {
            ...
            newchild.removeClass("clone");
            newchild.removeClass("hide");
            var image_url = extension + "global_assets/img/UnlistedProductImages/product-" + id + ".png";
            if (imageExists(image_url) === false) {
                image_url = extension + "global_assets/img/UnlistedProductImages/product-0.png";
            }
            newcount++;
        ...
        $.each(data, function (id, details) {
            ...
            btn.unbind("click").click(function () {
                ...
                if (details["status"] === "Pending" || details["status"] === "Rejected") {
                    ...
                    var document_url = extension + "global_assets/img/PDFDocuments/" + details["document_Url"] + ".pdf";
...
function DisplayWMSuppliers(data) {
    ...
    if (data === "none") {
        ...
        $.each(data, function (id, details) {
            count++;
            var image_url = extension + "global_assets/img/ProfilePicture/user-" + details["UserID"] + ".png";
            if (imageExists(image_url) === false) {
                image_url = extension + "global_assets/img/ProfilePicture/user-0.png";
            }
...
function DisplayUserSearchDetails(data, parent) {
    ...
    if (data["BeneficiaryName"] === "none") {
        ...
        var image_url = extension + "global_assets/img/ProfilePicture/user-" + data["Beneficiaryid"] + ".png";
        if (imageExists(image_url) === false) {
            image_url = extension + "global_assets/img/ProfilePicture/user-0.png";
        }
    ...
    if (data !== "none") {
        ...
        $.each(ids, function (index, id) {
            ...
            if (data[2] === "inbox") {
                ...
                var image_url = extension + "global_assets/img/ProfilePicture/user-" + uid + ".png";
                if (imageExists(image_url) === false) {
                    image_url = extension + "global_assets/img/ProfilePicture/user-0.png";
                }
...
function DisplayPromoProducts(data) {
    ...
    if (data === "none") {
        ...
        $.each(promoList, function (id, promo) {
            ...
            var addPromoProdBtn = newchild.find("#addPromoProdBtn").click(function () {
            ...
            addPromoProdBtn.tooltip({
                position: {
                    my: "center bottom-40", // the "anchor point" in the tooltip element
                    at: "center top" // the position of that anchor point relative to selected element
                }
            });
            var deletePromoBtn = newchild.find("#deletePromoBtn").click(function () {
                swal({
                    title: "Delete Promo/Deal",
                    text: "This action is irreversible, Promo Product(s) inclusive!!",
                    type: "info",
                    showCancelButton: true,
                    confirmButtonClass: 'btn btn-danger',
                    confirmButtonText: "Yes",
                    ...
                    if (dismiss.value) {
                        var data = promoid;
                        GetData("Product", "DeletePromo", "LoadGeneralAlert", data);
                    } else {
                        swal({
                            title: 'Safe',
            ...
            $.each(PromoProducts, function (id, data) {
                ...
                var image_url = extension + "global_assets/img/ProductImages/product-" + data["product_id"] + ".png";
                if (imageExists(image_url) === false) {
                    image_url = extension + "global_assets/img/ProductImages/product-0.png";
                }
                ...
                var btn2 = newsubchild.find(".editPromoProdPriceBtn");
                btn2.unbind().click(function () {
                    var prodid = data["product_id"];
                    ConfirmNewPromoProductPrice(promoid, prodid);
                });
                newsubchild.find(".deletePromoProdBtn").click(function () {
                    var prodid = data["product_id"];
                    swal({
                        title: "Delete Product",
                        ...
                        if (dismiss.value) {
                            var data = [promoid, prodid];
                            GetData("Product", "DeletePromoProduct", "LoadGeneralAlert", data);
                        } else {
                            swal({
                                title: 'Safe',
                                text: "Promo Product is safe!",
                                type: 'success',
                                showCancelButton: false,
                                confirmButtonText: 'Ok!',
                                confirmButtonClass: 'btn btn-success',
...
function DisplayUserContacts(data, parent, objecttype) {
    if (data === "none") {
        ...
        $.each(data, function (id, details) {
            ...
            newchild.removeClass("hide");
            newchild.addClass("newclone");
            var image_url = extension + "global_assets/img/ProfilePicture/user-" + id + ".png";
            if (imageExists(image_url) === false) {
                image_url = extension + "global_assets/img/ProfilePicture/user-0.png";
            }
            var contactid = id;
...
//        $("<div />", {class: "padding", text: "No Product"}).appendTo(parent);
        ...
        var image_url1 = extension + "global_assets/img/placeholders/product-0.png";
...
function DisplayBusinessList(data) {
    ...
    var image_url = extension + "global_assets/img/ProfilePicture/user-0.png";
...
function DisplayBusinessDetails(data) {
    ...
    var image_url = extension + "global_assets/img/ProfilePicture/user-" + bizid + ".png";
    if (imageExists(image_url) === false) {
        image_url = extension + "global_assets/img/ProfilePicture/user-0.png";
    }
...
function DisplayAllBooks(data) {
    ...
    if (data === "none") {
        ...
        $.each(data, function (id, details) {
            ...
            newchild.removeClass("clone");
            newchild.removeClass("hide");
            var image_url = extension + "global_assets/img/BookImages/book-" + id + ".png";
            if (imageExists(image_url) === false) {
                image_url = extension + "global_assets/img/BookImages/book-0.png";
            }
    ...
    var image_url1 = extension + "global_assets/img/BookImages/book-0.png";
...
function DisplayMonetisationApplications(params) {
    ...
    if (params.length == 0 || params == "") {
        ...
        $.each(params, function (ind, val) {
            ...
            var image_url = "../../../global_assets/img/ProfilePicture/user-" + val["userid"] + ".png";
            if (imageExists(image_url) === false) {
                image_url = "../../../global_assets/img/ProfilePicture/user-0.png";
            }
...
function MonetisationGoodsDetails(details) {
    ...
    $.each(productDetails, function (index, product) {
        ...
        var image_url = extension + "global_assets/img/UnlistedProductImages/product-" + index + ".png";
        if (imageExists(image_url) === false) {
            image_url = extension + "global_assets/img/ProductImages/product-0.png";
        }
...
function DisplayMonApplyPendingVerification(params) {
    ...
    if (params === "" || params === null || params.length === 0) {
        ...
        $.each(params, function (index, value) {
            ...
            var image_url = "../../../global_assets/img/ProfilePicture/user-" + value["userid"] + ".png";
            if (imageExists(image_url) === false) {
                image_url = "../../../global_assets/img/ProfilePicture/user-0.png";
            }
...
function VerifyMonetisationGoods(details, applicationID) {
    $(".modal-view-mon-verify-goods").on("show.bs.modal", function () {
        ...
        $.each(ProductDetails, function (index, value) {
            ...
            var prodId = value["id"];
            var image_url = extension + "global_assets/img/UnlistedProductImages/product-" + prodId + ".png";
            if (imageExists(image_url) === false) {
                image_url = extension + "global_assets/img/ProductImages/product-0.png";
            }
...
function displaySelectedPartyDetails(data, parent) {
    if (data === "none") {
        ...
        var image_url = extension + "global_assets/img/ProfilePicture/user-" + data["id"] + ".png";
        if (imageExists(image_url) === false) {
            image_url = extension + "global_assets/img/ProfilePicture/user-0.png";
        }
        newchild.find(".user-list-Image").attr("src", image_url);
